  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <button class="btn" @click="showPay">立即支付</button>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
...
import { reqWeixinPay, reqQueryPayStatus } from "../../api/pay";
...
export default {
  ...
  methods: {
    async showPay() {
      // 请求微信支付的地址
      const { codeUrl } = await reqWeixinPay(this.$route.query.orderId);
      // console.log(codeUrl);
